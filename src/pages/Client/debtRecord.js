...
const ShowDebtRecordPage = ({navigation}) => {
            ...
            <View style={styles.content}>
                ...
                <View style={styles.infoStackNavigator}>
                    ...
                    <View style={styles.contentBtnRecords}>
                        <TouchableOpacity style={[styles.btnRecords, styles.btnAtivo]}>
                            <Text style={styles.titleText}>
                                Compras
                            </Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={[styles.btnRecords]}>
                            <Text style={styles.titleText}>
                                Pagamentos
                            </Text>
                        </TouchableOpacity>
...
export default ShowDebtRecordPage;